...
import static org.newdawn.slick.opengl.renderer.SGL.GL_MODELVIEW_MATRIX;
...
public class EspUtils {
    ...
    public static double[] getInterpolatedPos(Entity entity) {
        ...
        return new double[]{
                MathUtils.interpolate(entity.lastTickPosX, entity.posX, ticks) - RenderManager.viewerPosX,
                MathUtils.interpolate(entity.lastTickPosY, entity.posY, ticks) - RenderManager.viewerPosY,
                MathUtils.interpolate(entity.lastTickPosZ, entity.posZ, ticks) - RenderManager.viewerPosZ
        };
    }
